...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    if(this!=NULL)
    {
        ...
        Node* antNodo= (Node*) malloc(sizeof(Node));
        Node* proxNodo= (Node*) malloc(sizeof(Node));
        if(nodeIndex==0)
        {
            if(ll_len(this)==0)
            {
            ...
            {
                proxNodo=this->pFirstNode;
                newNodo->pElement=pElement;
                newNodo->pNextNode=proxNodo;
            }
        ...
        }else
        {
            ...
            if(nodeIndex==ll_len(this))
            {
                newNodo->pElement=pElement;
                newNodo->pNextNode=NULL;
                antNodo->pNextNode=newNodo;
            }else
            {
                proxNodo=getNode(this,nodeIndex+1);
                newNodo->pElement=pElement;
                newNodo->pNextNode=proxNodo;
                antNodo->pNextNode=newNodo;
            }
...
int ll_add(LinkedList* this, void* pElement)
{
    ...
    if(this!=NULL)
    {
        ...
        newNodo->pElement=pElement;
        newNodo->pNextNode=NULL;
        int ultNodo=ll_len(this);
        if(ll_len(this)==0)
        {
            this->pFirstNode=newNodo;
        }else
        {
            antNodo=getNode(this,ultNodo-1);
            antNodo->pNextNode=newNodo;
        }
        this->size++;
        returnAux=0;
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this!=NULL && index>=0 && index<ll_len(this))
    {
        ...
        Node* antNode=(Node*) malloc(sizeof(Node));
    ...
    if(this!=NULL && pFunc!=NULL)
    {
        ...
        if(order==1||order==0)
        {
            for(i=0;i<ll_len(this)-1;i++)
            {
                ...
                {
                    orderPFunc=pFunc(ll_get(this,i),ll_get(this,j));
                    if(order==1 && orderPFunc>0)
                    {
                        auxElement=ll_get(this,i);
